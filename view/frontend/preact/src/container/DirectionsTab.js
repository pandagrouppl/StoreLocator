...
export default class DirectionsTab extends Component {
	constructor(props) {
		...
		this.state = {
			start: props.stateStore.waypoints.start,
			stop: props.initStop,
			mode: props.stateStore.waypoints.mode,
			locked: 'b',
		};
		this.textInputs = [];
	}
		...
		return (
			<div>
				<form onSubmit={this.handleSubmit} method="post" className="DirectionsTab">
					<label className={this.transitCssClass('DRIVING')}>
						<input
							type="radio"
							name="mode"
							value="DRIVING"
					...
					<label className={this.transitCssClass('TRANSIT')}>
						<input
							type="radio"
							name="mode"
							value="TRANSIT"
					...
					<label className={this.transitCssClass('WALKING')}>
						<input
							type="radio"
							name="mode"
							value="WALKING"
					...
					<div className="DirectionsTab__directions-flexbox">
						<div className="DirectionsTab__directions-wrapper">
							<div>
								<label className="DirectionsTab__input-label" for="route-start">
									A
								</label>
								<input
									className="DirectionsTab__input-field"
									id="route-start"
									name="start"
									type="text"
							...
							<div>
								<label className="DirectionsTab__input-label" for="route-stop">
									B
								</label>
								<input
									className="DirectionsTab__input-field"
						...
						<button
							type="button"
							className="DirectionsTab__input-button DirectionsTab__input-button--swap"
							onClick={() => {
								this.swapAddress();
							}}
						>
					...
					<input
						className="DirectionsTab__input-button DirectionsTab__input-button--submit"
						type="submit"
