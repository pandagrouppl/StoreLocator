				...
				<section className="storelocator-header__row storelocator-header__row--breadcrumbs">
					<ul className="breadcrumbs__items">
						...
						<li className="breadcrumbs__item">
							<strong className="breadcrumbs__item breadcrumbs__item--last">
								Store Locator
							</strong>
						</li>
					</ul>
				...
				<section className="storelocator-header__row">
					{this.props.stateStore.view === 'list' ? (
						<article className="storelocator-header__filters">
							{regions.map(region => (
								<RegionFilter
									className={this.isActiveFilter(region.name)}
									region={region.name}
						...
						<Link
							...
							className="storelocator-header__back-a"
						>
							<button className="storelocator-header__back">Back</button>
						</Link>
					)}
					<article>
						<a className="storelocator-header__reset" onClick={this.resetFilters}>
							Reset
						</a>
						<input
							className="storelocator-header__input"
							ref={input => {
								this.postcodeInput = input;
							}}
						...
						/>
						<button
							className="storelocator-header__search"
